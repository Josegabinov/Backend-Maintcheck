...
SECRET_KEY = 'django-insecure-4c#vjpjdcc+zxwn1##90t#-=^rz#m!0or40747fpjsj4s!^o%r'
...
AUTHENTICATION_BACKENDS = [
    ...
    # Agrega cualquier backend personalizado aquí
]
...
CORS_ALLOWED_ORIGINS = ["https://frontmainchecklogin.netlify.app"]
